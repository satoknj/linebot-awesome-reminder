...
describe('RemindedAt', () => {
    describe('constructor', () => {
        test('秒以下は0にして扱う', () => {
            const sut = new RemindedAt(dayjs('2021-10-12 07:00:05.222'));
            expect(sut.value.format('YYYY-MM-DD HH:mm:ss.SSS')).toBe('2021-10-12 07:00:00.000');
        });
    });
    test('format', () => {
    ...
    test('create', () => {
        const source ='2021-11-06T06:45:05+09:00Z';
